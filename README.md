...
- Cells marked as postponed, cancelled, or rescheduled are skipped instead of being added to the calendar.
- Online sessions include `(Online)` in the event title and use the time shown in the spreadsheet.
